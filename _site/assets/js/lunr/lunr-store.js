var store = [{
        ...
        "excerpt":"Notes From Concept to Implementation This is the first blog under the topic Data Lakes and will be followed by additional topics pertaining to data lakes. Each post will start with the title Data Lakes followed by a [:new topic]. Each topic will go deeper and share additional details and...","categories": ["big data","datalakes","fitbit"],
        "tags": [],
